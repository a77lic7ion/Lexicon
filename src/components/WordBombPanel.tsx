...
export const WordBombPanel: React.FC<WordBombPanelProps> = ({ bank, onExecute, playedWords, onClose }) => {
  ...
  return (
    <motion.div
      ...
      className="bg-slate-900 border border-slate-800 rounded-3xl shadow-2xl overflow-hidden mt-4"
    >
