  ...
  return (
    <div className="flex flex-col lg:flex-row gap-8 items-center justify-center p-4 bg-slate-950 min-h-screen w-full relative overflow-y-auto custom-scrollbar">
      <div className="flex flex-col gap-6 w-full lg:w-auto z-10 relative items-center lg:items-start">
        ...
        <div className="p-2 bg-slate-950 border border-slate-900 w-full overflow-x-auto shadow-inner rounded-xl">
        ...
        {error && (
          <div className="w-full bg-red-950/20 text-red-600 p-4 rounded-xl font-mono font-bold text-[9px] uppercase border border-red-900/30 flex items-center gap-3 animate-pulse">
        ...
        <div className="flex gap-4 w-full">
          <button
            ...
            className="flex-1 p-4 bg-slate-900 hover:bg-slate-800 disabled:opacity-30 rounded-xl font-mono font-bold text-[9px] text-slate-500 transition-all flex items-center justify-center gap-3 border border-slate-800 active:scale-95 shadow-lg"
          >
        ...
        <button
          ...
          disabled={player.tilesPlaced < 15}
          className={`
            w-full p-6 rounded-xl font-bold text-lg transition-all flex items-center justify-center gap-4 border active:scale-[0.98] shadow-2xl
            ${player.tilesPlaced < 15 
              ? 'bg-slate-900 border-slate-800 text-slate-700 cursor-not-allowed opacity-50'
              : 'bg-emerald-700 border-emerald-600 text-white hover:bg-emerald-600 shadow-emerald-900/40'}
          `}
        >
        ...
        <div className="bg-slate-900/40 p-6 rounded-2xl border border-slate-800 flex flex-col gap-6 shadow-2xl backdrop-blur-sm">
          <div className="flex justify-between items-center">
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 bg-slate-950 hover:bg-slate-900 rounded-lg text-[8px] font-mono font-bold text-yellow-600 border border-slate-800 transition-all active:scale-95"
            >
          ...
          <div className="flex flex-col gap-8 overflow-y-auto max-h-[60vh] pr-2 custom-scrollbar">
            <section className="flex flex-col gap-3">
              ...
              <div className="flex flex-wrap gap-2 p-3 bg-slate-950 rounded-xl border border-slate-900 shadow-inner">
                {commonTiles.map(t => {
